    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #description>
                    Add a new app member to your team, allowing them to collaborate with you.
                </template>
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                            <button
                                ...
                                :key="role.key"
                                type="button"
                                class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-black focus:ring-2 focus:ring-black"
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title>
                    Pending App Invitations
                </template>

                <template #description>
                    These people have been invited to your app and have been sent an invitation email. They may join the app by accepting the email invitation.
                </template>
